...
Client::Client()
{
	...
	//mRoboCat = std::static_pointer_cast< RoboCatClient >(GameObjectRegistry::sInstance->CreateGameObject('RCAT'));
	//mRoboCat->setmSpriteComponent();
	////SpriteComponent(*mRoboCat)
	
	//RenderManager::sInstance->AddComponent(SpriteComponent(mRoboCat))
}
